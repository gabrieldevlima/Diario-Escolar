...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO auxiliaradministrativo SET nome = :nome, cpf = :cpf, email = :email, telefone = :telefone");	
	...
	$res = $pdo->prepare("UPDATE auxiliaradministrativo SET nome = :nome, cpf = :cpf, email = :email,, telefone = :telefone WHERE id = '$id'");
