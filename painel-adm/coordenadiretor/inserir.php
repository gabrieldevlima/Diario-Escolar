...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO coordenadiretor SET nome = :nome, cpf = :cpf, email = :email, telefone = :telefone");	
	...
	$res = $pdo->prepare("UPDATE coordenadiretor SET nome = :nome, cpf = :cpf, email = :email, telefone = :telefone WHERE id = '$id'");
