...
<div class="row mt-4 mb-4">
    <a type="button" class="btn-primary btn-sm ml-3 d-none d-md-block" href="index.php?pag=<?php echo $pag ?>&funcao=novo"><i style="margin-right: 5px" style="margin-top: 5px" class='fas fa-plus-circle fa-lg'></i>Novo Professor </a>
