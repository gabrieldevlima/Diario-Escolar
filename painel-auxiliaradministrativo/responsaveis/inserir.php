...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO responsaveis SET nome = :nome, cpf = :cpf, email = :email, telefone = :telefone");	

}else{
	$res = $pdo->prepare("UPDATE responsaveis SET nome = :nome, cpf = :cpf, email = :email, telefone = :telefone WHERE id = '$id'");
