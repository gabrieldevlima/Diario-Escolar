...
<div class="modal" id="modal-lancar-notas" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bg-light">
            <div class="modal-header">
                <h6 class="modal-title"><?php echo '(' .$nome_disc . ' - '. $serie . ' ' . $turmal . ')  ' ?> <span id="txtnomealuno"></span></h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <label><b>Selecione o Conceito</b></label>
                <select id="nota" name="nota" class="form-control">
                  <option value=" "></option>
                  <option value="D">Desenvolvido</option>
                  <option value="ED">Em Desenvolvimento</option>
                  <option value="CD">Com Dificuldade</option>
                  <option value="ND">Não Desenvolvido</option>
                ...
                <label><b>Tipo de Avaliação:</b></label>
                ...
                <label style="margin-top:10px"><b>Informe a Avaliação:</b></label>
                <input type="number" step="0.01" class="form-control" id="nota" name="nota">
                            ...
                            <div align="right">
                                <button type="submit" name="btn-salvar-nota" id="btn-salvar-nota" class="btn btn-success mb-4">Registrar Avaliação</button>
                            </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <span class="ml-4"><b>Avaliações do Aluno </b></span>
                        <small>
