            ...
            <table class="table table-bordered" id="minhaTabela" width="100%" cellspacing="0">
                ...
                <tbody>
                 ...
                 for ($i=0; $i < count($res); $i++) {
                  ...
                  <tr>
                    <td>
                        <a href="../rel/boletim.php?id=<?php echo $id ?>" title="Gerar Boletim" class="text-dark"><?php echo $nome ?></a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input value="<?php echo @$matricula ?>" type="hidden" name="antigo" id="antigo">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                for ($i=0; $i < count($res); $i++) {
                  ...
                  <a target="_blank" title="Gerar boletim" href="../rel/contrato.php?id=<?php echo $id_m ?>"><span class="ml-2"><i class='fas fa-book-open text-primary'></i></span></a>
