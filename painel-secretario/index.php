...
$menu1 = "alunos";
$menu2 = "professores";
$menu3 = "coordenadiretor";
$menu4 = "auxiliaradministrativo";
$menu5 = "turmas";
$menu6 = "aulas";
$menu7 = "alunos2021";
$menu8 = "turmas2021";
...
<head>
    ...
    <title>Painel Secretaria | SEMED</title>
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #003c16;" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?pag=<?php echo $menu3 ?>">
                    ...
                    <span>Coordenadores / Diretores</span></a>
            </li>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?pag=<?php echo $menu4 ?>">
                    ...
                    <span>Auxiliares Administrativos</span></a>
            </li>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu7 ?>">Alunos</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Turmas</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Aulas</a>
                    </div>
                </div>
            </li>
            </li>
